...
public class CartItemServlet extends MyServlet {
	...
	public String loadCartItems(HttpServletRequest req, HttpServletResponse resp)
		...
		String cartItemIds = req.getParameter("cartItemIds");//获取cartItemIds
		double total = Double.parseDouble(req.getParameter("total"));
		List<CartItem> cartItemList = cartItemService.loadCartItems(cartItemIds);//调用service方法完成加载，并保存到request中
		req.setAttribute("cartItemList", cartItemList);//设置属性
		req.setAttribute("total", total);
		req.setAttribute("cartItemIds", cartItemIds);
		return "f:/frontpages/cart/showitem.jsp";//转发到/jsps/cart/showitem.jsp页面显示
	}
